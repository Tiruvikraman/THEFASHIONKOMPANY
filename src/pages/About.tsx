...
const founderPositions = [
  ...
  },
  {
    ...
    logo: bsl,
    color: "#059669",
    src: "https://bslassociation.com/"
  },
];

/* ─── PASTE YOUR FOUNDER IMAGE IMPORT HERE ──────────────────────────────── */
const founderImg = "src/assets/founder_image.jpeg";
...
const Particle = ({ x, y, delay, size }: any) => (
  <motion.div
    ...
    style={{
      ...
      background: "radial-gradient(circle, rgba(139,92,246,0.0), transparent)"
    }}
    animate={{ y: [0, -30, 0], opacity: [0.4, 0.9, 0.4] }}
    transition={{ duration: 4 + delay, delay, repeat: Infinity, ease: "easeInOut" }}
  />
);
const bgImage = "src/assets/abt_pg_bg.jpeg";
    ...
    <main className="pt-20 overflow-x-hidden font-sans" style={{ fontFamily: "'Outfit', 'Segoe UI', sans-serif" }}>
      ...
      <section ref={heroRef} className="relative min-h-[88vh] flex items-center overflow-hidden grain">
        <motion.div className="absolute inset-0" style={{ y: heroY }}>
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#0a0a1a]/75" />
        ...
        {[[10, 20, 0, 12], [80, 60, 1, 8], [30, 75, 2, 14], [60, 15, 0.5, 10], [90, 40, 1.5, 6]].map(([x, y, d, s], i) => (
        ...
        <motion.div className="relative container max-w-6xl px-6 py-32" style={{ opacity: heroOpacity }}>
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0}
            ...
            <span className="text-xs text-indigo-200 tracking-widest uppercase font-semibold">Tirupur, India · Est. 1998</span>
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={0.5}
            ...
            <h1 className="text-6xl md:text-8xl font-black leading-[0.9]">
              <span className="gcm-logo-text gcm-logo-shadow gcm-logo-shadow" style={{ color: "#ac1b1b" }}>Gloria Casa Moda</span>
            </h1>
          </motion.div>

          <motion.p variants={fadeUp} initial="hidden" animate="visible" custom={2}
            className="mt-8 text-lg md:text-xl text-white/100 max-w-2xl leading-relaxed font-light">
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={3}
            ...
            <button onClick={() => navigate("/contact")} className="group flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-400 hover:to-purple-500 text-white font-semibold px-7 py-3.5 rounded-full shadow-lg shadow-indigo-500/30 transition-all">
              Get a Quote <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button onClick={() => navigate("/products")} className="flex items-center gap-2 border border-white/30 hover:border-white/60 text-white/80 hover:text-white px-7 py-3.5 rounded-full backdrop-blur transition-all">
              View Catalogue
            </button>
          </motion.div>
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={4}
            ...
            {stats.map((s, i) => (
              <div key={i} className="text-center">
                ...
                <p className="text-xs text-white/100 uppercase tracking-widest mt-1">{s.label}</p>
              </div>
            ))}
          </motion.div>
        </motion.div>
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="container max-w-6xl px-6 relative">
          ...
          <div className="flex flex-wrap gap-16 items-start">
            ...
            {/* Portrait only (no position cards here anymore) */}
          ...
          {/* ── POSITIONS ROW — full width below portrait + text ── */}
          <div className="mt-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {founderPositions.map((pos, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  custom={i}
                  onClick={() => window.open(pos.src, "_blank", "noopener,noreferrer")}
                  className="pos-card relative flex flex-col gap-4 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm overflow-hidden cursor-pointer hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
                >
                  {/* accent bar */}
                  <div
                  ...
                  {/* org logo */}
                  <div
                    className="w-14 h-14 rounded-xl shrink-0 overflow-hidden flex items-center justify-center border shadow-sm"
                    ...
                    <img
                      ...
                      onError={e => {
                        ...
                        if (!parent.querySelector("span")) {
                          ...
                          span.style.cssText = `font-size:18px;font-weight:700;color:${pos.color}`;
                  ...
                  <div className="flex-1">
                    <p className="text-m font-bold text-gray-800 leading-snug mb-1">
                      {pos.org}
                    </p>
                  ...
                  <div className="flex items-center gap-2 pt-2 border-t border-gray-50">
                    ...
                    <span className="text-[14px] text-gray-400 uppercase tracking-wider font-medium">Active</span>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-32 relative overflow-hidden" style={{ background: "linear-gradient(160deg, #0f0f23 0%, #1a1040 50%, #0f172a 100%)" }}>
        ...
        <div className="container max-w-6xl px-6 relative">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}
            ...
            <h2 className="text-5xl font-black text-white">What We <span className="shimmer-text">Do</span></h2>
          ...
          <div className="flex flex-wrap gap-16 items-center">
            ...
            <div className="flex-1 min-w-[280px]">
              ...
              <motion.h2 variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={1}
                ...
                The <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Tirupur</span>
                <br />Advantage
              </motion.h2>
              <motion.p variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={2}
                className="text-gray-500 text-lg leading-relaxed">
                Tirupur accounts for over 90% of India's cotton knitwear exports.
